...
namespace Driveable.Core
{
    ...
    public struct OnTrafficToRCC : IEvent { public int driverIndex; }
    #endregion
    ...
    [Serializable] public struct DriveableButtons
    {
    ...
    [Serializable] public struct TPSCharacter
    {
        ...
        public CinemachineVirtualCamera vEnterExitCamera;
    }
    ...
    [Serializable] public struct Driver
    {
        public DriverSO driverSO;
