...
namespace AkaitoAi
{
    public class PlaceObjectOnClick : EditorWindow
    {
        ...
        [MenuItem("AkaitoAi/Tools/GameObject/Click to Place Object")]
        ...
        private void OnGUI()
        {
            _prefab = EditorGUILayout.ObjectField("Prefab to Place:", _prefab, typeof(GameObject), false) as GameObject;
        ...
        private void OnSceneGUI(SceneView sceneView)
        {
            ...
            if (e.type == EventType.MouseDown && e.button == 0 && Physics.Raycast(ray, out hit))
            {
                ...
                GameObject newObject = PrefabUtility.InstantiatePrefab(_prefab, hit.transform.parent) as GameObject;
